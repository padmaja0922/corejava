...
public class PaymentDao {
	...
	public static int verifyCardDetails(CreditCard card) {
		...
		//String input = "C:\\bcj-dec16\\workspace\\corejava\\PSBusinessRegent\\resource\\CreditCardInfo.txt";

		int x = 0;

		try {

			inputFile = new BufferedReader(new FileReader(System.getenv("CATALINA_HOME")+"\\webapps\\CreditCardInfo.txt"));
