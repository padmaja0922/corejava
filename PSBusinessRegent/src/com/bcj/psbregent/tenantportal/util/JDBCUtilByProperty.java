...
public class JDBCUtilByProperty {
	...
	public static Connection getConnectionByProperty() {
		...
		//	input = new FileInputStream(System.getProperty("user.dir")+"\\resource\\db.properties");
			
			input = new FileInputStream(System.getenv("CATALINA_HOME")+"\\webapps\\db.properties");
